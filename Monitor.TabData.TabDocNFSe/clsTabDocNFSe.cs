...
[ReportClass]
public class clsTabDocNFSe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFSe _FormTabData;

	public clsTabDocNFSe()
	{
		base.TabName = "TabDocNFSe";
		base.TabText = "NFSe: Dados sintéticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocNFSe(base.TabText, base.TabColor, base.FeatExtId);
