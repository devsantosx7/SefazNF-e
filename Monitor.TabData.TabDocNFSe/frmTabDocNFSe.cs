...
using srv.fiscal.io;
using srv.fiscal.io.Metrics.TabDataSqlHandler.TabDataItem;
using util.fiscal.io;

namespace Monitor.TabData.TabDocNFSe;

public class frmTabDocNFSe : Form
{
	...
	private clsSrvTabDocNFSe _SqlTabData = new clsSrvTabDocNFSe();
	...
	public frmTabDocNFSe(string pTitle, Color pColumnColor, string pFeatExtId)
	{
		InitializeComponent();
		Text = pTitle;
	...
	private void funcDefineListViewFeatures()
	{
		...
		{
			DocDocItem docDocItem = (DocDocItem)x;
			return (docDocItem == null) ? null : varclsValidator.funcGetDesc(docDocItem);
		};
		olvInfCpl.AspectGetter = delegate(object x)
		{
			...
			return string.IsNullOrEmpty(_InfoAddXml) ? null : clsScreenGeral.funcGetDocText(docDocItem.Chave)?.infCpl;
		};
		olvInfAdFisco.AspectGetter = delegate(object x)
		{
			...
			return string.IsNullOrEmpty(_InfoAddXml) ? null : clsScreenGeral.funcGetDocText(docDocItem.Chave)?.infAdFisco;
		};
	...
	{
		clsHelpService.funcCallTipReportNFSeSyntheticAsync();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.TabData.TabDocNFSe.frmTabDocNFSe));
		...
		this.lsvData.Columns.AddRange(new System.Windows.Forms.ColumnHeader[54]
		{
			...
			this.olvValor, this.olvStatus, this.olvDtEntFisc, this.olvDtRegFisc, this.olvUsRegFisc, this.olvDcNumFisc, this.olvEmitID, this.olvEmitNome, this.olvEstado, this.olvChave,
			this.olvFilial, this.olvTpDoc, this.olvNatOper, this.olvIndSimplesNac, this.olvCFOP, this.olvNCM, this.olvISSQNCdSrv, this.olvISSQNTribut, this.olvISSQNTPret, this.olvISSQNTaxa,
			this.olvISSQNValor, this.olvTpImunidade, this.olvTotalRet, this.olvxProd, this.olvTomaID, this.olvTomaNome, this.olvTomaIE, this.olvTomaIM, this.olvInterID, this.olvInterNome,
			this.olvProcEmi, this.olvxLocEmi, this.olvxLocPrest, this.olvnProcesso, this.olvTagUser, this.olvTagDtHr, this.olvDocNote, this.olvDocNoteDtHr, this.olvDocNoteUser, this.olvInfCpl,
			this.olvInfAdFisco, this.olvAnoMes, this.olvError, this.olvVersion
		});
		...
		this.olvEmitID.ToolTipText = "Número de Inscrição Federal do Emitente";
		this.olvEmitID.Width = 135;
		...
		this.olvIndSimplesNac.Width = 135;
		...
		this.olvTotalRet.Text = "Valor Total Retido";
		this.olvTotalRet.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		...
		this.olvxProd.ToolTipText = "Descrição do Serviço do Prestado";
		this.olvxProd.Width = 135;
		...
		this.olvInterID.ToolTipText = "Nome do intermediário";
		...
		this.olvxLocEmi.Text = "Local Emitente";
		...
		this.olvxLocPrest.Text = "Local Prestação";
		...
		this.olvnProcesso.Text = "Processo";
		this.olvnProcesso.ToolTipText = "Número do processo judicial";
		this.olvnProcesso.Width = 90;
		...
		this.lknAction.Text = "NFSe Dados Sintéticos";
		...
		this.lbText01.Text = "Apresenta a visualização de todas as informações presentes no cabeçalho de NFSe.";
		...
		this.lbTitle01.Text = "NFSe: Dados Sintéticos é ativado nos \r\nplanos Avançado e Enterprise.";
		...
		base.Name = "frmTabDocNFSe";
		this.Text = "NFSe: Dados Sintéticos";
