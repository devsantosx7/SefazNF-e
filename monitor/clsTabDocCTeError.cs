...
[ReportClass]
public class clsTabDocCTeError : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocCTeError _FormTabData;

	private clsSrvTabDocCTeError _SqlTabData = new clsSrvTabDocCTeError();

	public clsTabDocCTeError()
	{
		base.TabName = "TabDocCTeError";
		base.TabText = "CTe incorretos";
		base.FeatExtId = clsFeatureService.consReportDocCTeError;
		base.TabColor = Color.FromArgb(244, 164, 96);
		_FormTabData = new frmTabDocCTeError(base.TabText, base.TabColor, base.FeatExtId);
