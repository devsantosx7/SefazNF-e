...
[ReportClass]
public class clsTabDocNFeAverConf : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFeAverConf _FormTabData;

	private clsSrvTabDocNFeAverConf _SqlTabData = new clsSrvTabDocNFeAverConf();

	public clsTabDocNFeAverConf()
	{
		base.TabName = "TabDocNFeAverConf";
		base.TabText = "Averbação de embarque";
		base.FeatExtId = clsFeatureService.consReportDocNFeAverConf;
		base.TabColor = Color.FromArgb(158, 227, 190);
		_FormTabData = new frmTabDocNFeAverConf(base.TabText, base.TabColor, base.FeatExtId);
	}
