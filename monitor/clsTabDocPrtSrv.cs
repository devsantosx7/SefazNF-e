...
[ReportClass]
public class clsTabDocPrtSrv : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocPrtSrv _FormTabData;

	private clsSrvTabDocPrtSrv _SqlTabData = new clsSrvTabDocPrtSrv();

	public clsTabDocPrtSrv()
	{
		base.TabName = "TabDocPrtSrv";
		base.TabText = "CTe em desacordo";
		base.FeatExtId = clsFeatureService.consReportDocPrtSrv;
		base.TabColor = Color.FromArgb(251, 220, 190);
		_FormTabData = new frmTabDocPrtSrv(base.TabText, base.TabColor, base.FeatExtId);
	...
	public void funcSearchText(string pSearchTerm, bool pSearchInteligent)
	{
		if (_FormTabData != null)
		{
			_FormTabData.funcSearchText(pSearchTerm);
		}
	}
