...
public class frmTabDocRetTercr : Form
{
	...
	private clsSrvTabDocRetTercr _SqlTabData = new clsSrvTabDocRetTercr();
	...
	private ListView lsvTabDocRetTercr;
	...
	private ColumnHeader clInVenc;

	private ColumnHeader clInCancel;

	private ColumnHeader clInHasEvent;

	private ColumnHeader clInCNPJ;

	private ColumnHeader clInNome;

	private ColumnHeader clInMotivo;

	private ColumnHeader clInEstado;

	private ColumnHeader clInChave;

	private ColumnHeader clInFilial;

	private ColumnHeader clInTpDoc;

	private ColumnHeader clInNatOper;

	private ColumnHeader clInBaseIcms;

	private ColumnHeader clInValorIcms;
	...
	public frmTabDocRetTercr(string pTitle, Color pColumnColor, string pFeatExtId)
	{
		InitializeComponent();
		Text = pTitle;
	...
	private async void frmTabDocRetTercr_Load(object sender, EventArgs e)
	{
		...
		clsFunction.funcSetColumnsConfiguration(this, lsvTabDocRetTercr);
		_ColumnsLoaded = true;
		lsvTabDocRetTercr.Columns[0].ImageIndex = 16;
		...
		if (_IsLocked)
		{
			...
			lsvTabDocRetTercr.Dock = DockStyle.None;
		...
		{
			lsvTabDocRetTercr.Dock = DockStyle.Fill;
	...
	private async Task<clsReturn> funcShowDataAsync(clsDataFilter pclsFilter, List<Document> pDocList)
	{
		...
		lsvTabDocRetTercr.BeginUpdate();
		lsvTabDocRetTercr.SuspendLayout();
		lsvTabDocRetTercr.Items.Clear();
		int varCounter = 0;
		...
		{
			lsvTabDocRetTercr.ShowGroups = false;
			lsvTabDocRetTercr.Groups.Clear();
		}
		else
		{
			lsvTabDocRetTercr.ShowGroups = true;
		}
		foreach (Document varclsDocument in pDocList)
		{
			...
			{
				string varPartnerIdnt = clsFunction.funcGetValue(varclsDocument.EmitID);
				string varPartnerName = clsFunction.funcGetValue(varclsDocument.EmitNome);
				...
				if (!varGroupByText.Equals(varPartnerIdnt))
				{
					...
					varListGroup = lsvTabDocRetTercr.Groups.Add(varPartnerIdnt, varGroupHeaderText);
				}
			...
			else if (pclsFilter.GroupByDate)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varclsDocument.DtAut, varclsDocument.DtAut);
				}
			...
			else if (pclsFilter.GroupByYearMonth)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varAnoMes, varAnoMes);
				}
			...
			else if (pclsFilter.GroupByState)
			{
				if (!varGroupByText.Equals(varclsDocument.cUF))
				{
					...
					varListGroup = lsvTabDocRetTercr.Groups.Add(varclsDocument.cUF, varGroupHeaderText2);
				}
			...
			else if (pclsFilter.GroupByModel)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varModel, varModel);
				}
			...
			else if (pclsFilter.GroupByTpDoc)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varTipoDoc, varTipoDoc);
				}
			...
			else if (pclsFilter.GroupByNatOper)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varNatOper, varNatOper);
				}
			...
			else if (pclsFilter.GroupByCFOP)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varDocCFOP, varDocCFOP);
				}
			...
			else if (pclsFilter.GroupByFilial)
			{
				...
				if (!varGroupByText.Equals(varFilialId))
				{
					...
					varListGroup = lsvTabDocRetTercr.Groups.Add(varFilialId, varGroupHeaderText3);
				}
			...
			else if (pclsFilter.GroupByTomaIE)
			{
				...
				{
					varListGroup = lsvTabDocRetTercr.Groups.Add(varDocTomaIE, varDocTomaIE);
				}
			...
			lsvTabDocRetTercr.Items.Add(varListItem);
		}
		lsvTabDocRetTercr.EndUpdate();
		lsvTabDocRetTercr.ResumeLayout();
	...
	private ListViewItem funcFillItem(ListViewItem pListItem, Document pclsDocument)
	{
		...
		varDocType = clsFunction.funcGetDocType(pclsDocument.Model);
		pListItem.SubItems.Add(varDocType);
		pListItem.Tag = new ObjDoc
		{
			FiliaKey = pclsDocument.Filial,
			DocmtKey = pclsDocument.Chave
		};
		...
		pListItem.SubItems.Add(pclsDocument.Valor);
		pListItem.SubItems.Add(pclsDocument.DVenc);
		...
		pListItem.SubItems.Add(pclsDocument.HasEvent);
		...
		pListItem.SubItems.Add(pclsDocument.xMotivo);
		Estado varEstado = _StateList.FirstOrDefault((Estado r) => r.Code.Equals(pclsDocument.cUF));
		if (varEstado != null)
		{
		...
		pListItem.SubItems.Add(_clsDFeCodes.funcGetTipoDoc(pclsDocument.Model, pclsDocument.TpDoc));
		pListItem.SubItems.Add(pclsDocument.NatOper);
		pListItem.SubItems.Add(pclsDocument.BaseICMS);
		pListItem.SubItems.Add(pclsDocument.ValorICMS);
	...
	{
		foreach (ListViewItem varListItem in lsvTabDocRetTercr.Items)
		{
	...
	{
		return await clsScreenGeral.funcExportToCsvAsync(lsvTabDocRetTercr, onProgressChange);
	}
	...
	{
		return clsFunction.funcGetListViewItens(lsvTabDocRetTercr, pAllItens: false, pFocused, pChecked);
	}
	...
	private async Task<bool> funcRefreshListAsync(List<Document> pDocList, List<ListViewItem> pViewList)
	{
		...
		{
			ObjDoc varObjView = (ObjDoc)varListItem.Tag;
			if (varObjView != null)
			{
				Document varclsDoc = pDocList.FirstOrDefault((Document r) => clsFunction.IsEqual(r.Filial, varObjView.FiliaKey) && clsFunction.IsEqual(r.Chave, varObjView.DocmtKey));
				if (varclsDoc != null)
				{
					funcFillItem(varListItem, varclsDoc);
				}
			}
		}
		return true;
	...
	{
		return lsvTabDocRetTercr.Items.Count;
	}
	...
	{
		clsHelpService.funcCallTipReportNFeDevolutionTercAsync();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.frmTabDocRetTercr));
		...
		this.lsvTabDocRetTercr = new System.Windows.Forms.ListView();
		...
		this.clInVenc = new System.Windows.Forms.ColumnHeader();
		this.clInManifest = new System.Windows.Forms.ColumnHeader();
		this.clInCancel = new System.Windows.Forms.ColumnHeader();
		this.clInHasEvent = new System.Windows.Forms.ColumnHeader();
		this.clInCNPJ = new System.Windows.Forms.ColumnHeader();
		this.clInNome = new System.Windows.Forms.ColumnHeader();
		this.clInMotivo = new System.Windows.Forms.ColumnHeader();
		this.clInEstado = new System.Windows.Forms.ColumnHeader();
		this.clInChave = new System.Windows.Forms.ColumnHeader();
		this.clInFilial = new System.Windows.Forms.ColumnHeader();
		this.clInTpDoc = new System.Windows.Forms.ColumnHeader();
		this.clInNatOper = new System.Windows.Forms.ColumnHeader();
		this.clInBaseIcms = new System.Windows.Forms.ColumnHeader();
		this.clInValorIcms = new System.Windows.Forms.ColumnHeader();
		...
		base.SuspendLayout();
		this.contextMenuDocs.Items.AddRange(new System.Windows.Forms.ToolStripItem[2] { this.tsmCopyDocKey, this.toolStripSeparator21 });
		this.contextMenuDocs.Name = "contextMenuDocs";
		this.contextMenuDocs.Size = new System.Drawing.Size(269, 32);
		...
		this.toolStripSeparator21.Size = new System.Drawing.Size(265, 6);
		this.pnContent.Controls.Add(this.tlpProgress);
		this.pnContent.Controls.Add(this.lsvTabDocRetTercr);
		...
		this.lsvTabDocRetTercr.Activation = System.Windows.Forms.ItemActivation.OneClick;
		this.lsvTabDocRetTercr.Alignment = System.Windows.Forms.ListViewAlignment.Left;
		this.lsvTabDocRetTercr.AllowColumnReorder = true;
		this.lsvTabDocRetTercr.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
		this.lsvTabDocRetTercr.CheckBoxes = true;
		this.lsvTabDocRetTercr.Columns.AddRange(new System.Windows.Forms.ColumnHeader[25]
		{
			this.clInHasXml, this.clInTipo, this.clInTag, this.clInNum, this.clInSerie, this.clInDtAut, this.clInValor, this.clInVenc, this.clInManifest, this.clInCancel,
			this.clInHasEvent, this.clInCNPJ, this.clInNome, this.clInMotivo, this.clInEstado, this.clInChave, this.clInFilial, this.clInTpDoc, this.clInNatOper, this.clInBaseIcms,
			this.clInValorIcms, this.clInCFOP, this.clInNCM, this.clInError, this.clDocNote
		});
		this.lsvTabDocRetTercr.ContextMenuStrip = this.contextMenuDocs;
		this.lsvTabDocRetTercr.Font = new System.Drawing.Font("Verdana", 8.25f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.lsvTabDocRetTercr.FullRowSelect = true;
		this.lsvTabDocRetTercr.HideSelection = false;
		this.lsvTabDocRetTercr.Location = new System.Drawing.Point(0, 0);
		this.lsvTabDocRetTercr.Name = "lsvTabDocRetTercr";
		this.lsvTabDocRetTercr.ShowItemToolTips = true;
		this.lsvTabDocRetTercr.Size = new System.Drawing.Size(784, 116);
		this.lsvTabDocRetTercr.SmallImageList = this.ImageListDocs;
		this.lsvTabDocRetTercr.TabIndex = 8;
		this.lsvTabDocRetTercr.UseCompatibleStateImageBehavior = false;
		this.lsvTabDocRetTercr.View = System.Windows.Forms.View.Details;
		this.lsvTabDocRetTercr.ColumnClick += new System.Windows.Forms.ColumnClickEventHandler(lstView_ColumnClick);
		this.lsvTabDocRetTercr.ColumnReordered += new System.Windows.Forms.ColumnReorderedEventHandler(lstView_ColumnReordered);
		this.lsvTabDocRetTercr.ColumnWidthChanged += new System.Windows.Forms.ColumnWidthChangedEventHandler(lstView_ColumnWidthChanged);
		this.lsvTabDocRetTercr.ItemChecked += new System.Windows.Forms.ItemCheckedEventHandler(lstView_ItemChecked);
		this.lsvTabDocRetTercr.DoubleClick += new System.EventHandler(lstView_DoubleClick);
		...
		this.clInVenc.Text = "Venc.";
		this.clInVenc.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.clInVenc.Width = 80;
		this.clInManifest.Text = "Manifestação";
		this.clInCancel.Text = "Can";
		this.clInCancel.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.clInCancel.Width = 35;
		this.clInHasEvent.Text = "Evt";
		this.clInHasEvent.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.clInHasEvent.Width = 35;
		...
		this.clInMotivo.Text = "Status";
		this.clInMotivo.Width = 200;
		this.clInEstado.DisplayIndex = 16;
		this.clInEstado.Text = "UF";
		this.clInChave.DisplayIndex = 14;
		this.clInChave.Text = "Chave";
		this.clInFilial.DisplayIndex = 15;
		this.clInFilial.Text = "Filial";
		this.clInTpDoc.Text = "TipoDoc";
		this.clInNatOper.Text = "Natureza";
		this.clInBaseIcms.Text = "Base ICMS";
		this.clInBaseIcms.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.clInValorIcms.Text = "Valor ICMS";
		this.clInValorIcms.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		...
		this.lknAction.Text = "Notas de devolução";
		...
		this.lbText01.Text = "Lista as NFe de devolução emitidas por clientes da empresa cadastrada no sistema, capturando-as em até 1 hora após sua criação pelo cliente.";
		...
		this.lbTitle01.Text = "NFes de devolução de terceiros é ativado nos \r\nplanos Avançado e Enterprise.";
		...
		base.Name = "frmTabDocRetTercr";
		this.Text = "NFes de devolução terceiros";
		base.Load += new System.EventHandler(frmTabDocRetTercr_Load);
