...
[ReportClass]
public class clsTabExpBalance : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabExpBalance _FormTabData;

	public clsTabExpBalance()
	{
		base.TabName = "TabExpBalance";
		base.TabText = "Exportação Geral: Saldos e Prazos";
		base.FeatExtId = clsFeatureService.consReportDocExportBalance;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabExpBalance(base.TabText, base.TabColor, base.FeatExtId);
	...
	public async Task<clsReturn> funcExportToExcelAsync(Action<decimal> onProgressChange)
	{
		...
		return await _FormTabData.funcExportToExcelAsync();
	}
