...
[ReportClass]
public class clsTabDocOut : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocOut _FormTabData;

	public clsTabDocOut()
	{
		base.TabName = "TabDocOut";
		base.TabText = "Emitidos pela empresa";
		base.TabColor = Color.LightSkyBlue;
		_FormTabData = new frmTabDocOut(base.TabText, base.TabColor, base.FeatExtId);
