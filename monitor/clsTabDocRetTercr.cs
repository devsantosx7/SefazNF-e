...
[ReportClass]
public class clsTabDocRetTercr : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocRetTercr _FormTabData;

	private clsSrvTabDocRetTercr _SqlTabData = new clsSrvTabDocRetTercr();

	public clsTabDocRetTercr()
	{
		base.TabName = "TabDocRetTercr";
		base.TabText = "NFe de devolução terceiros";
		base.FeatExtId = clsFeatureService.consReportDocRetTercr;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocRetTercr(base.TabText, base.TabColor, base.FeatExtId);
	}
