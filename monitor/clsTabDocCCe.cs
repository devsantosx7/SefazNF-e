...
[ReportClass]
public class clsTabDocCCe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocCCe _FormTabData;

	private clsSrvTabDocCCe _SqlTabData = new clsSrvTabDocCCe();

	public clsTabDocCCe()
	{
		base.TabName = "TabDocCCe";
		base.TabText = "Cartas de correção";
		base.FeatExtId = clsFeatureService.consReportDocCCe;
		base.TabColor = Color.FromArgb(245, 244, 192);
		_FormTabData = new frmTabDocCCe(base.TabText, base.TabColor, base.FeatExtId);
