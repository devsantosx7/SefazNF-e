...
[ReportClass]
public class clsTabDocNFeDet : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFeDet _FormTabData;

	public clsTabDocNFeDet()
	{
		base.TabName = "TabDocNFeDet";
		base.TabText = "NFe: Dados analíticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocNFeDet(base.TabText, base.TabColor, base.FeatExtId);
