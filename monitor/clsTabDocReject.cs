...
[ReportClass]
public class clsTabDocReject : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocReject _FormTabData;

	private clsSrvTabDocReject _SqlTabData = new clsSrvTabDocReject();

	public clsTabDocReject()
	{
		base.TabName = "TabDocReject";
		base.TabText = "Notas recusadas";
		base.FeatExtId = clsFeatureService.consReportDocReject;
		base.TabColor = Color.FromArgb(255, 179, 179);
		_FormTabData = new frmTabDocReject(base.TabText, base.TabColor, base.FeatExtId);
