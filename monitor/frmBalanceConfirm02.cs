...
public class frmBalanceConfirm02 : Form
{
	...
	public frmBalanceConfirm02(ObjectMeasure clsObjMeasure, clsBalanceService.BalanceModel pclsBalance, decimal pTotalCost)
	{
		InitializeComponent();
	...
	private async void frmBalanceConfirm02_Load(object sender, EventArgs e)
	{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.frmBalanceConfirm02));
		...
		this.lkbSupportChat.Location = new System.Drawing.Point(45, 283);
		...
		this.picSupportChat.Location = new System.Drawing.Point(8, 282);
		...
		base.ClientSize = new System.Drawing.Size(575, 321);
		...
		base.Name = "frmBalanceConfirm02";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Fiscal.io - Saldo indisponível para créditos especiais";
		base.Load += new System.EventHandler(frmBalanceConfirm02_Load);
