...
[ReportClass]
public class clsTabExpDirRem : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabExpDirRem _FormTabData;

	public clsTabExpDirRem()
	{
		base.TabName = "TabExpDirRem";
		base.TabText = "Exportação Direta: Formação de Lote";
		base.FeatExtId = clsFeatureService.consReportDocExpDirRemBal;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabExpDirRem(base.TabText, base.TabColor, base.FeatExtId);
