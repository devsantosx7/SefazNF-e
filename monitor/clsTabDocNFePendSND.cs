...
[ReportClass]
public class clsTabDocNFePendSND : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFePendSND _FormTabData;

	private clsSrvTabDocNFePendSND _SqlTabData = new clsSrvTabDocNFePendSND();

	public clsTabDocNFePendSND()
	{
		base.TabName = "TabDocNFePendSND";
		base.TabText = "NFe pendentes de entrega";
		base.FeatExtId = clsFeatureService.consReportDocNFePendSND;
		base.TabColor = Color.FromArgb(245, 244, 192);
		_FormTabData = new frmTabDocNFePendSND(base.TabText, base.TabColor, base.FeatExtId);
