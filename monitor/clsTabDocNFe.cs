...
[ReportClass]
public class clsTabDocNFe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFe _FormTabData;

	public clsTabDocNFe()
	{
		base.TabName = "TabDocNFe";
		base.TabText = "NFe: Dados sintéticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocNFe(base.TabText, base.TabColor, base.FeatExtId);
