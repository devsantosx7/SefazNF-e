...
public class frmOnboardStep02Ch05Sc03 : Form
{
	...
	public frmOnboardStep02Ch05Sc03()
	{
		InitializeComponent();
	}
	...
	private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
	{
		...
		clsHelpService.funcCallWebPage("https://suporte.fiscal.io/portal/pt/kb/articles/adicionando-creditos-de-download-na-versao-gratuita", "onboard");
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.frmOnboardStep02Ch05Sc03));
		...
		this.label3.Text = "Isso é suficiente para baixar 14 documentos.";
		...
		this.label6.Size = new System.Drawing.Size(533, 20);
		this.label6.TabIndex = 222;
		this.label6.Text = "a sua versão gratuita vem com R$ 1,00 em créditos para você testar.";
		...
		this.label4.Image = Monitor.Resources.circle_filled;
		...
		this.linkLabel1.Location = new System.Drawing.Point(3, 240);
		this.linkLabel1.Name = "linkLabel1";
		this.linkLabel1.Size = new System.Drawing.Size(533, 16);
		this.linkLabel1.TabIndex = 208;
		this.linkLabel1.TabStop = true;
		this.linkLabel1.Text = "Adquirindo créditos de downloads na versão gratuita";
		...
		this.label1.Text = "Para ajudar você a decidir se investe no serviço ou não,";
		...
		this.label2.Size = new System.Drawing.Size(533, 28);
		this.label2.TabIndex = 199;
		this.label2.Text = "Esta tecnologia de downlodas envole custos.";
		...
		base.Name = "frmOnboardStep02Ch05Sc03";
		this.Text = "frmOnboardStep02Ch05Sc03";
