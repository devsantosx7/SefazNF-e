...
[ReportClass]
public class clsTabExpIndRem : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabExpIndRem _FormTabData;

	public clsTabExpIndRem()
	{
		base.TabName = "TabExpIndRem";
		base.TabText = "Exportação Indireta: Saldos e Prazos";
		base.FeatExtId = clsFeatureService.consReportDocExpIndRemBal;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabExpIndRem(base.TabText, base.TabColor, base.FeatExtId);
