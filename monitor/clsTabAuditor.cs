...
public class clsTabAuditor : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabAuditor _FormTabData;

	public clsTabAuditor()
	{
		base.TabName = "TabAuditor";
		base.TabText = "Auditor Fiscal";
		base.TabColor = Color.LightBlue;
		base.FeatExtId = clsFeatureService.consFeatFiscalAudit;
		_FormTabData = new frmTabAuditor(base.TabText, base.TabColor, base.FeatExtId);
	...
	public clsReturn funcSendDocs(Action<decimal> onProgressChange)
	{
		if (_FormTabData == null)
		{
			return new clsReturn();
		}
		return _FormTabData.funcGetAuditGroupToSend(onProgressChange);
	}
