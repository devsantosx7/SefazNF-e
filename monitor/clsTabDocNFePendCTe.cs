...
[ReportClass]
public class clsTabDocNFePendCTe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFePendCTe _FormTabData;

	private clsSrvTabDocNFePendCTe _SqlTabData = new clsSrvTabDocNFePendCTe();

	public clsTabDocNFePendCTe()
	{
		base.TabName = "TabDocNFePendCTe";
		base.TabText = "NFe Pendentes de Transporte";
		base.FeatExtId = clsFeatureService.consReportDocNFePendCTe;
		base.TabColor = Color.FromArgb(245, 244, 192);
		_FormTabData = new frmTabDocNFePendCTe(base.TabText, base.TabColor, base.FeatExtId);
