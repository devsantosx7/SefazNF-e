...
[ReportClass]
public class clsTabDocRetPropr : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocRetPropr _FormTabData;

	private clsSrvTabDocRetPropr _SqlTabData = new clsSrvTabDocRetPropr();

	public clsTabDocRetPropr()
	{
		base.TabName = "TabDocRetPropr";
		base.TabText = "NFe de devolução própria";
		base.FeatExtId = clsFeatureService.consReportDocRetPropr;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocRetPropr(base.TabText, base.TabColor, base.FeatExtId);
