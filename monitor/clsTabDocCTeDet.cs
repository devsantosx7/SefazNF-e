...
[ReportClass]
public class clsTabDocCTeDet : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocCTeDet _FormTabData;

	public clsTabDocCTeDet()
	{
		base.TabName = "TabDocCTeDet";
		base.TabText = "CTe: Dados analíticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocCTeDet(base.TabText, base.TabColor, base.FeatExtId);
