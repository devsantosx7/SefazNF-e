...
[ReportClass]
public class clsTabDocCTe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocCTe _FormTabData;

	public clsTabDocCTe()
	{
		base.TabName = "TabDocCTe";
		base.TabText = "CTe: Dados sintéticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocCTe(base.TabText, base.TabColor, base.FeatExtId);
