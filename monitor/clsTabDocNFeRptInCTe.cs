...
[ReportClass]
public class clsTabDocNFeRptInCTe : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFeRptInCTe _FormTabData;

	private clsSrvTabDocNFeRptInCTe _SqlTabData = new clsSrvTabDocNFeRptInCTe();

	public clsTabDocNFeRptInCTe()
	{
		base.TabName = "TabDocNFeRptInCTe";
		base.TabText = "CTe cobrança duplicada";
		base.FeatExtId = clsFeatureService.consReportDocNFeRptInCTe;
		base.TabColor = Color.FromArgb(245, 244, 192);
		_FormTabData = new frmTabDocNFeRptInCTe(base.TabText, base.TabColor, base.FeatExtId);
