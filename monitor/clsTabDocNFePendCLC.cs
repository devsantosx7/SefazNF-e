...
[ReportClass]
public class clsTabDocNFePendCLC : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFePendCLC _FormTabData;

	private clsSrvTabDocNFePendCLC _SqlTabData = new clsSrvTabDocNFePendCLC();

	public clsTabDocNFePendCLC()
	{
		base.TabName = "TabDocNFePendCLC";
		base.TabText = "NFe pendentes de coleta";
		base.FeatExtId = clsFeatureService.consReportDocNFePendCLC;
		base.TabColor = Color.FromArgb(245, 244, 192);
		_FormTabData = new frmTabDocNFePendCLC(base.TabText, base.TabColor, base.FeatExtId);
	}
