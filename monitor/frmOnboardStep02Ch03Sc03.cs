...
public class frmOnboardStep02Ch03Sc03 : Form
{
	...
	public frmOnboardStep02Ch03Sc03()
	{
		InitializeComponent();
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.frmOnboardStep02Ch03Sc03));
		...
		this.label7.Text = "Para buscar CFe SAT e NFCe é preciso realizar uma configuração especial.";
		...
		this.label6.Image = Monitor.Resources.circle_empty;
		...
		this.label1.Text = " para obter orientações.";
		...
		this.linkLabel1.Location = new System.Drawing.Point(3, 287);
		...
		this.label3.Text = "Se preferir, entre em contato";
		...
		this.label2.Size = new System.Drawing.Size(533, 77);
		this.label2.TabIndex = 207;
		this.label2.Text = "A captura de documentos de saída com sucesso \r\ndepende da escolha da estratégia mais adequada \r\npara cada caso.";
		...
		base.Name = "frmOnboardStep02Ch03Sc03";
		this.Text = "frmOnboardStep02Ch03Sc03";
