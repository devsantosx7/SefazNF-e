...
[ReportClass]
public class clsTabDocNFSeDet : clsAbsTabData, intDocTabData, IDisposable
{
	private frmTabDocNFSeDet _FormTabData;

	public clsTabDocNFSeDet()
	{
		base.TabName = "TabDocNFSeDet";
		base.TabText = "NFSe: Dados analíticos";
		base.FeatExtId = clsFeatureService.consReportAnaliticSintetic;
		base.TabColor = Color.FromArgb(225, 248, 194);
		_FormTabData = new frmTabDocNFSeDet(base.TabText, base.TabColor, base.FeatExtId);
