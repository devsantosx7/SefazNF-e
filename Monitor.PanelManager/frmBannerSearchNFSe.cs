...
public class frmBannerSearchNFSe : Form
{
	private Timer _timer;

	private clsDataParameter _clsDataParam = new clsDataParameter();

	private string _FeatExtId = clsFeatureService.consFeatScanDocNFSeIn;
	...
	private async void frmBannerSearchNFSe_Load(object sender, EventArgs e)
	{
	...
	private void frmBannerSearchNFSe_Leave(object sender, EventArgs e)
	{
		if (_timer != null)
		{
			_timer.Stop();
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Monitor.PanelManager.frmBannerSearchNFSe));
		...
		this.chkRememberAgain.ForeColor = System.Drawing.SystemColors.ControlText;
		...
		base.Name = "frmBannerSearchNFSe";
		base.ShowIcon = false;
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		base.Load += new System.EventHandler(frmBannerSearchNFSe_Load);
		base.Leave += new System.EventHandler(frmBannerSearchNFSe_Leave);
