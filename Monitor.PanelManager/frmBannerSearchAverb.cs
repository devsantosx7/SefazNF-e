...
public class frmBannerSearchAverb : Form
{
	...
	private string _FeatExtId = clsFeatureService.consReportDocNFeAverConf;
	...
	private void frmBannerSearchAverb_Leave(object sender, EventArgs e)
	{
		if (_timer != null)
		{
			_timer.Stop();
	...
	private void InitializeComponent()
	{
		...
		this.BackgroundImage = Monitor.Resources.banner_campanha_averbação;
		...
		base.Name = "frmBannerSearchAverb";
		base.ShowIcon = false;
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		base.Load += new System.EventHandler(frmPanelBackup_Load);
		base.Leave += new System.EventHandler(frmBannerSearchAverb_Leave);
