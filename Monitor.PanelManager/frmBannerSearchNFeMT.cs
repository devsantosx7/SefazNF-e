...
public class frmBannerSearchNFeMT : Form
{
	...
	public frmBannerSearchNFeMT()
	{
		...
		_timer.Tick += async delegate
		{
			...
			await _clsDataParam.funcSetAsync("BANNER-SHOW-DATE-" + _FeatExtId + "-MT-LAST-SHOW", varDateTime);
			Close();
			_timer.Stop();
	...
	private async void frmBannerSearchNFeMT_Load(object sender, EventArgs e)
	{
		if (!clsFunction.IsEmpty(await _clsDataParam.funcGetAsync("NOT-SHOW-AGAIN-" + _FeatExtId + "-MT")))
		{
	...
	private async void btClose_Click(object sender, EventArgs e)
	{
		...
		{
			await _clsDataParam.funcSetAsync("NOT-SHOW-AGAIN-" + _FeatExtId + "-MT", "X");
		}
		...
		await _clsDataParam.funcSetAsync("BANNER-SHOW-DATE-" + _FeatExtId + "-MT-NEXT-SHOW", varDateTimeStr);
	...
	private void frmBannerSearchNFeMT_Leave(object sender, EventArgs e)
	{
		if (_timer != null)
		{
			_timer.Stop();
	...
	private void InitializeComponent()
	{
		...
		this.BackgroundImage = Monitor.Resources.banner_nfe_mt1;
		...
		base.Name = "frmBannerSearchNFeMT";
		base.ShowIcon = false;
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		base.Load += new System.EventHandler(frmBannerSearchNFeMT_Load);
		base.Leave += new System.EventHandler(frmBannerSearchNFeMT_Leave);
