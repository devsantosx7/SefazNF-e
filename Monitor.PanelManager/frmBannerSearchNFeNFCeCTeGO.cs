...
public class frmBannerSearchNFeNFCeCTeGO : Form
{
	...
	private string _FeatExtId = clsFeatureService.consFeatScanDocNFeOut;
	...
	public frmBannerSearchNFeNFCeCTeGO()
	{
		InitializeComponent();
		_timer = new Timer();
		_timer.Tick += async delegate
		{
			...
			await _clsDataParam.funcSetAsync("BANNER-SHOW-DATE-" + _FeatExtId + "-GO-LAST-SHOW", varDateTime);
			Close();
			_timer.Stop();
	...
	private async void frmBannerSearchNFeNFCeCTeGO_Load(object sender, EventArgs e)
	{
		if (!clsFunction.IsEmpty(await _clsDataParam.funcGetAsync("NOT-SHOW-AGAIN-" + _FeatExtId + "-GO")))
		{
	...
	private async void btClose_Click(object sender, EventArgs e)
	{
		...
		{
			await _clsDataParam.funcSetAsync("NOT-SHOW-AGAIN-" + _FeatExtId + "-GO", "X");
		}
		...
		await _clsDataParam.funcSetAsync("BANNER-SHOW-DATE-" + _FeatExtId + "-GO-NEXT-SHOW", varDateTimeStr);
	...
	private async void btSalesContact_Click(object sender, EventArgs e)
	{
		...
		string varFeatCustomDesc = "Busca de saídas de NFe, NFCe e CTe de Goiás";
		string varFeatCustomLongDesc = "Capture notas fiscais de saída do estado de Goiás";
		frmSalesPayed02 frmSalesPayed = new frmSalesPayed02(_FeatExtId, varFeatCustomDesc, varFeatCustomLongDesc);
	...
	private void frmBannerSearchNFeNFCeCTeGO_Leave(object sender, EventArgs e)
	{
		if (_timer != null)
		{
			_timer.Stop();
	...
	private void InitializeComponent()
	{
		...
		this.chkRememberAgain.ForeColor = System.Drawing.Color.Black;
		...
		this.BackgroundImage = Monitor.Resources.banner_nfe_cte_nfce_go;
		...
		base.Name = "frmBannerSearchNFeNFCeCTeGO";
		base.ShowIcon = false;
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		base.Load += new System.EventHandler(frmBannerSearchNFeNFCeCTeGO_Load);
		base.Leave += new System.EventHandler(frmBannerSearchNFeNFCeCTeGO_Leave);
